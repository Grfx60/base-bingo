...
export default function Page() {
  ...
  // Cüzdan bağlama işlemini OnchainKit bileşenleri otomatik yapar veya 
  // aşağıda wagmi üzerinden tetikleyebiliriz.
  ...
  // DURUM 1: Kullanıcı cüzdanını henüz bağlamamışsa
  if (!isConnected) {
    return (
  ...
  // DURUM 2: Cüzdan bağlı ama imza onayı verilmemişse
  if (!isSigned) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen p-4 bg-slate-900 text-white">
        <h1 className="text-4xl font-extrabold mb-2 tracking-wide text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-emerald-400">
  ...
  // DURUM 3: Her iki aşama da tamamlandıysa oyunu yükle
